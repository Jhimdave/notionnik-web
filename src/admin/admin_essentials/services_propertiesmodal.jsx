...
import { T, PROPERTY_TYPES, NOTION_COLORS, COLOR_DOTS, inputStyle, sectionLabel } from "./constants";
import { BASE_URL, ADMIN_KEY } from "./constants";
import { AlertBox, Field } from "./primitives";

export default function PropertiesModal({ onClose, onPropsChanged }) {
  ...
  async function handleAdd() {
    ...
    try {
      ...
      const res  = await fetch(`${BASE_URL}/admin/services/new-property`, {
        method: "POST",
  ...
  async function handleDelete(name) {
    ...
    try {
      const res  = await fetch(`${BASE_URL}/admin/services/property`, {
        method: "DELETE",
        headers: { "Content-Type": "application/json", "x-api-key": ADMIN_KEY },
