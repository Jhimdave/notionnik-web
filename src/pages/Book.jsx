    ...
    <main className="pt-24">
      <section className="py-16 border-b border-white/[0.05]">
        <div className="max-w-7xl mx-auto px-5 md:px-8">
          ...
          <h1 className="section-title text-white mb-4">Book a Free <span className="gradient-text-blue">Consultation</span></h1>
              ...
              <div className="card-glass p-8 md:p-10">
                {sent ? (
                  <div className="text-center py-14">
                    ...
                    <p className="text-blue-200/60 text-sm leading-relaxed max-w-xs mx-auto">Thanks for reaching out. We'll review your message and get back within 24 hours to schedule your discovery call.</p>
                  </div>
                ) : (
                  <form onSubmit={submit} className="space-y-5">
                    ...
                    <div>
                      ...
                      <select value={form.service} onChange={e=>set('service',e.target.value)} className={`${inputCls} cursor-pointer`}
                    ...
                    <button type="submit" disabled={loading} className="btn-primary w-full justify-center text-base py-3.5" style={{ opacity: loading ? 0.75 : 1 }}>
                      <span>{loading ? 'Sending…' : 'Book My Discovery Call'}</span>
                      {!loading && (<svg width="15" height="15" fill="none" stroke="currentColor" strokeWidth={2.5} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M5 12h14M12 5l7 7-7 7"/></svg>)}
                    </button>
