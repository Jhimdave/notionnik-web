...
const VALUES = [
  {
    icon: "⚡",
    title: "Speed",
    desc: "We build fast and deploy even faster. Your systems go live without the long wait.",
  },
  {
    icon: "🎯",
    title: "Precision",
    desc: "Every automation is tested, documented, and built to work exactly as designed.",
  },
  {
    icon: "🔒",
    title: "Reliability",
    desc: "We design for uptime. Your workflows run 24/7 without breaking or needing babysitting.",
  },
  {
    icon: "🤝",
    title: "Partnership",
    desc: "We stay with you as your systems grow — not just for the build, but for the long run.",
  },
];
      ...
      <section className="py-16 border-b border-white/[0.05]">
        <div className="max-w-7xl mx-auto px-5 md:px-8">
          ...
          <p className="text-blue-200/60 text-base max-w-lg leading-relaxed">
            A team of automation specialists, Notion builders, and systems
            thinkers dedicated to helping businesses eliminate repetitive work
            ...
            {[
              {
                n: "01",
                title: "Our Mission",
                body: "To eliminate manual, repetitive work from every business we touch. Your time is too valuable to spend on tasks a well-built system can handle automatically. We engineer those systems so you can focus on growth — not grinding.",
              },
              {
                n: "02",
                title: "Our Approach",
                body: "We start by deeply understanding your workflow, then design a custom automation strategy using the right tools for your needs — Notion, n8n, Make, Google Apps, or AI. Every solution is built to scale as your business grows.",
              },
            ].map((s) => (
              <div key={s.n} className="card-glass p-9">
                <div className="flex items-center gap-4 mb-6">
                  <span className="font-mono text-4xl font-bold text-brand-500/25">
                    {s.n}
                  </span>
        ...
        <div className="max-w-7xl mx-auto px-5 md:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {VALUES.map((v) => (
              ...
              >
                <div className="w-10 h-10 rounded-xl bg-brand-500/12 border border-brand-500/20 flex items-center justify-center text-xl mb-4">
                  {v.icon}
                </div>
      ...
      <section className="py-10">
        <div className="max-w-7xl mx-auto px-5 md:px-8">
          ...
          <h2 className="section-title text-white mb-2 text-3xl">
            The people behind{" "}
            <span className="gradient-text-blue">the systems</span>
          </h2>
          <p className="text-blue-200/55 text-base mb-12">
            Meet the specialists who build your automation stack.
          </p>
          ...
          <div className="card-glass p-10 md:p-14 flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              ...
              <p className="text-blue-200/55">
                Book a free call and let's talk about what we can build.
              </p>
            </div>
            <Link to="/book">
              <button className="btn-primary px-8 py-4 text-base flex-shrink-0">
