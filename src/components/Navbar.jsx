  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-5 md:px-8 h-[68px] flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-1">
          {LINKS.map((l) => (
            ...
            >
              ...
              {isActive(l.to) && (
                <span
                  className={`absolute bottom-1 left-1/2 -translate-x-1/2 w-1 h-1 rounded-full ${isDark ? "bg-brand-400" : "bg-[#2d8ef5]"}`}
                />
              )}
            </Link>
          ))}
            ...
            <div
              className={`flex items-center gap-2 px-3 py-1.5 rounded-full border cursor-pointer transition-all hover:scale-105 ${
                isDark
                  ...
                  : "bg-[rgba(45,142,245,0.1)] border-[rgba(45,142,245,0.25)] hover:bg-[rgba(45,142,245,0.2)]"
              }`}
            >
        ...
        >
          <span
            className={`block w-5 h-0.5 rounded transition-all duration-300 ${menuOpen ? "rotate-45 translate-y-2" : ""} ${isDark ? "bg-white" : "bg-[#0d2b4d]"}`}
          />
          <span
            className={`block w-5 h-0.5 rounded transition-all duration-300 ${menuOpen ? "opacity-0" : ""} ${isDark ? "bg-white" : "bg-[#0d2b4d]"}`}
          />
          <span
            className={`block w-5 h-0.5 rounded transition-all duration-300 ${menuOpen ? "-rotate-45 -translate-y-2" : ""} ${isDark ? "bg-white" : "bg-[#0d2b4d]"}`}
          />
      ...
      >
        <div
          className={`px-5 py-4 flex flex-col gap-1 backdrop-blur-xl ${
            isDark
        ...
        >
          ...
          <div className="pt-3 pb-1 flex flex-col gap-3">
            ...
            >
              <span
                className={`text-sm font-semibold ${isDark ? "text-blue-200/60" : "text-[#1a3a5c]"}`}
              >
                Theme
              </span>
              <ThemeToggle />
